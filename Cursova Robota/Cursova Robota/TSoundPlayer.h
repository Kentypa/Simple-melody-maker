...
public:
    ...
    // Вилучає останню ноту з списку
    void RemoveFromTrackLastSound();

    // Повертає ссилку на список всіх звуків у мелодії
